...
st.caption(
    "Puedes usarlo sin PDF (General Chat). "
    "Si subes un PDF, se habilita RAG, Resumen y Opinión basada en el documento."
)
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        if st.session_state.db is None and mode != "General Chat (sin documento)":
            st.info("The document hasn't been uploaded; I'm learning from the information you give me.")
